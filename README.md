...
## <h3>5. Write your DC name as DC01. You can write your own naming convention. Leave other option as a default as we are just doing for our home lab. </h3>
...
## <h3>6. Write admin username as dcadmin or of your own and choose your strong password. Remember to copy to notepad for later use. And click next to disk management. </h3>
...
## <h3>7. Leave default as it show or choose appropriate size for your virtual machine based on your requirements and budget, and Click next to network management.</h3>
...
## <h3>9. Now you can click on review and create. The dialouge box will appear something as below showing "validation pass" and click on create. You can leave other option as default for now for your home lab setup.</h3>
...
## <h3>10. You will get dialogue box as "Your deployment is complete". Now click on "Go to resource". </h3>
...
## <h3>12. Click on "Download RDP file" and open the file to connect to VM and put your username and password initially created to login through RDP.</h3>
...
## Now the installation for Window server 2019 is COMPLETED.
<h3>Please check my other repository for installing Active Directory Domain Services and making it as a Domain Controller</h3>
